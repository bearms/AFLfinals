...
print("Collingwood vs Port Adelaide")
print("Brisbane vs Melbourne")
print("Carlton vs Sydney")
print("St Kilda vs GWS Giants")
input("Press Enter to start Round 1...")

round_1_game_1_winner, round_1_game_1_loser = play_game('Collingwood', 'Port Adelaide')
round_1_game_2_winner, round_1_game_2_loser = play_game('Brisbane', 'Melbourne')
round_1_game_3_winner, round_1_game_3_loser = play_game('Carlton', 'Sydney')
round_1_game_4_winner, round_1_game_4_loser = play_game('St Kilda', 'GWS Giants')

# The winner of the bottom 4 will play the losers of the top 4, the losers in the games are knocked out.

print("\nRound 2 Lineup:")
print(f"{round_1_game_3_winner} vs {round_1_game_2_loser}")
print(f"{round_1_game_4_winner} vs {round_1_game_1_loser}")
input("Press Enter to start Round 2...")

round_2_game_1_winner, round_2_game_1_loser = play_game(round_1_game_3_winner, round_1_game_2_loser)
round_2_game_2_winner, round_2_game_2_loser = play_game(round_1_game_4_winner, round_1_game_1_loser)
...
print(f"{round_2_game_1_winner} vs {round_1_game_2_winner}")
print(f"{round_2_game_2_winner} vs {round_1_game_1_winner}")
input("Press Enter to start Preliminary Finals...")

prelim_finals_winner, prelim_finals_loser = play_game(round_2_game_1_winner, round_1_game_2_winner)
